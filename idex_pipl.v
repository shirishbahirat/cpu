...
always @(alu_src, im_gen, mem_to_rgs, rda, reg_wr, rb, rdb, instruction, mem_rd, mem_wr, brnch, reset, ra, wa, alu_op) begin: IDEX_PIPL_ID_EX
    if ((reset == 1)) begin
