...
always @(rda, alu_op, reset, wa, instruction, im_gen, rdb, mem_wr, reg_wr, mem_rd, brnch, rb, ra, alu_src, mem_to_rgs) begin: IDEX_PIPL_ID_EX
    if ((reset == 1)) begin
